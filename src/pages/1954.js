...
export const query1954 = graphql`
  {
    ...
    february: allAirtable(
      filter: { table: { eq: "data1954" }, data: { month: { eq: "February" } } }
      sort: { fields: data___orderId }
    ) {
      edges {
        node {
    ...
    march: allAirtable(
      filter: { table: { eq: "data1954" }, data: { month: { eq: "March" } } }
      sort: { fields: data___orderId }
    ) {
      edges {
        node {
    ...
    april: allAirtable(
      filter: { table: { eq: "data1954" }, data: { month: { eq: "April" } } }
      sort: { fields: data___orderId }
    ) {
      edges {
        node {
    ...
    may: allAirtable(
      filter: { table: { eq: "data1954" }, data: { month: { eq: "May" } } }
      sort: { fields: data___orderId }
    ) {
      edges {
        node {
    ...
    june: allAirtable(
      filter: { table: { eq: "data1954" }, data: { month: { eq: "June" } } }
      sort: { fields: data___orderId }
    ) {
      edges {
        node {
    ...
    july: allAirtable(
      filter: { table: { eq: "data1954" }, data: { month: { eq: "July" } } }
      sort: { fields: data___orderId }
    ) {
      edges {
        node {
    ...
    august: allAirtable(
      filter: { table: { eq: "data1954" }, data: { month: { eq: "August" } } }
      sort: { fields: data___orderId }
    ) {
      edges {
        node {
    ...
    october: allAirtable(
      filter: { table: { eq: "data1954" }, data: { month: { eq: "October" } } }
      sort: { fields: data___orderId }
    ) {
      edges {
        node {
    ...
    november: allAirtable(
      filter: { table: { eq: "data1954" }, data: { month: { eq: "November" } } }
      sort: { fields: data___orderId }
    ) {
      edges {
        node {
    ...
    december: allAirtable(
      filter: { table: { eq: "data1954" }, data: { month: { eq: "December" } } }
      sort: { fields: data___orderId }
    ) {
      edges {
        node {
